...
class Product extends Model
{
    ...
    protected $table = 'manifests'; // Nama tabel baru di database
    ...
    public function stockTransactions() { return $this->hasMany(StockTransaction::class, 'product_id'); }
    ...
    // Helper untuk update stock manual
